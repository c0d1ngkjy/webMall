<template>
  <q-page class="">
    ...
    <q-form ref="formRef" class="q-px-xl column items-start">
      ...
      <q-input label="출간일" v-model="newBookData.releaseDate"></q-input>
      <q-input label="총 페이지수" v-model="newBookData.totalPages"></q-input>
      <q-input label="카테고리" v-model="newBookData.category"></q-input>
      <q-input label="가격" v-model="newBookData.unitPrice"></q-input>
      <q-input label="재고" v-model="newBookData.unitsInStock"></q-input>
